...
\label{sec:orgff6a9c6}
\subsection{MELPA}
\label{sec:org9905b31}
\begin{verbatim}
(require 'package)
...
\label{sec:org7105e4c}
\subsection{Theme}
\label{sec:orge89a91c}
...
\label{sec:org0edcc84}
\subsection{Hints}
\label{sec:org89d0517}
...
\section{Languages}
\label{sec:orga2af21e}
\subsection{Tools}
\label{sec:org52360c6}
Syntax checking.
\begin{verbatim}
...
\label{sec:orgb592b47}
\subsection{Other Emacs settings}
\label{sec:org53aa8e2}
