...
\label{sec:org6b701e0}
\subsection{MELPA}
\label{sec:orgd09e8cb}
\begin{verbatim}
(require 'package)
...
\label{sec:org0039be9}
\subsection{Theme}
\label{sec:org5285fde}
...
\label{sec:org8c4f4b2}
\subsection{Hints}
\label{sec:orgc58717f}
...
\section{Languages}
\label{sec:org0599f98}
\subsection{Tools}
\label{sec:org708475e}
Syntax checking.
\begin{verbatim}
...
\label{sec:org3dbb46e}
\subsection{Other Emacs settings}
\label{sec:org95b248f}
