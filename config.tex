...
\label{sec:org6808bc0}
\subsection{MELPA}
\label{sec:orgf2d5fe3}
\begin{verbatim}
(require 'package)
...
\label{sec:orgc474544}
\subsection{Theme}
\label{sec:org16fd30a}
...
\label{sec:org7b2d3e9}
\subsection{Hints}
\label{sec:org6bf1c62}
...
\section{Languages}
\label{sec:org4fd9b64}
\subsection{Tools}
\label{sec:org963ba6d}
Syntax checking.
\begin{verbatim}
