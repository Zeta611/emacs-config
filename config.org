...
#+begin_src emacs-lisp
  (use-package mixed-pitch
    ...
    ;;  (font-xlfd-name (font-spec :registry "fontset-variable")))
    ;; (set-fontset-font "fontset-variable" 'latin (font-spec :name "EB Garamond" :size 19.0))
    ;; (set-fontset-font "fontset-variable" 'hangul (font-spec :name "Noto Serif CJK KR" :size 19.0))
